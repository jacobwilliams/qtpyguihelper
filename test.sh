...
python -m pytest tests/test_doc_examples.py -v
...
python -m pytest tests/test_nested_values.py -v
...
python -m pytest tests/test_tkinter_comprehensive.py -v
...
python -m pytest tests/wx_test_utils.py -v